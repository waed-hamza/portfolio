...
document.getElementsByClassName("nav-ul-a")[0].style.borderBottom = "2px solid #FFFF77";
for(let i=0; i<7; i++){
...
window.onscroll = function(){
  ...
  // Home
  if((window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) >= 0 && (window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) < 0.154394){
    document.getElementsByClassName("nav-ul-a")[0].style.color = '#FFFF77';
    document.getElementsByClassName("nav-ul-a")[0].style.borderBottom = "2px solid #FFFF77";
  }else{
  ...
  // About
  if((window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) >= 0.154394 && (window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) < 0.356295){
    document.getElementsByClassName("nav-ul-a")[1].style.color = '#FFFF77';
    document.getElementsByClassName("nav-ul-a")[1].style.borderBottom = "2px solid #FFFF77";
  }else{
  ...
  // Projects
  if((window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) >= 0.356295 && (window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) < 0.451306){
  ...
  // Skills
  if((window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) >= 0.451306 && (window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) < 0.617577){
    document.getElementsByClassName("nav-ul-a")[3].style.color = '#FFFF77';
    document.getElementsByClassName("nav-ul-a")[3].style.borderBottom = "2px solid #FFFF77";
  }else{
   ...
   // Certficate
   if((window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) >= 0.617577 && (window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) < 0.87886){
    document.getElementsByClassName("nav-ul-a")[4].style.color = '#FFFF77';
    document.getElementsByClassName("nav-ul-a")[4].style.borderBottom = "2px solid #FFFF77";
  }else{
  ...
  // Resume
  if((window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) >= 0.87886 && (window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) < 0.973872){
    document.getElementsByClassName("nav-ul-a")[5].style.color = '#FFFF77';
    document.getElementsByClassName("nav-ul-a")[5].style.borderBottom = "2px solid #FFFF77";
  }else{
  ...
  // Contact
  if((window.pageYOffset / (document.body.offsetHeight - window.innerHeight)) >=  0.973872){
    document.getElementsByClassName("nav-ul-a")[6].style.color = '#FFFF77';
    document.getElementsByClassName("nav-ul-a")[6].style.borderBottom = "2px solid #FFFF77";
  }else{
